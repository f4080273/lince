        ...
        <div class="col-md-3 mobile-hide">
          <div class="special-links">
              ...
              <?}?>
				...
				<div class="col-md-9">
          <?if($get_ProdctCatalogById->Catalog_Image != ''){?>
          <div class="col-md-12" style="margin-bottom:15px">
            <img src="<?=_Web_Url?>/images/catalog/<?=$get_ProdctCatalogById->Catalog_Image?>" alt="<?=$get_ProdctCatalogById->Catalog_Name?>">
          </div>
          <?}?>
          <div class="col-md-6 shop-box">
            <?foreach ($get_DataList['Data'] as $row) {?>
						<a href="<?=_Web_Url?>/product/detail/<?=$row->Product_CatalogId?>/<?=$row->Product_Id?>">
